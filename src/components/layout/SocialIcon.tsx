...
import type { SocialNetwork } from "@/types/content";

/**
 * Ícones de redes sociais em SVG inline (traço, estilo Lucide).
 * Ícones de marca não fazem parte do lucide-react, então ficam aqui.
 */
